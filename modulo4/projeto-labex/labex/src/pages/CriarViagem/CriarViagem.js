...
const urlCreateTrip = "https://us-central1-labenu-apis.cloudfunctions.net/labeX/vitoria-galdino-barros/trips"
...
return (
    ...
    <CriarViagemDiv>
        ...
        <FormDiv>
            ...
            <input type="date" placeholder='Data' size="50" value={date} onChange={onChangeDate} required ></input>
