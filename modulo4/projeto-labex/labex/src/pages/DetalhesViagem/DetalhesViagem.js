...
const DetalhesViagem = () => {
    ...
    const getTripDetails = () => {
        axios
        .get(`https://us-central1-labenu-apis.cloudfunctions.net/labeX/vitoria-galdino-barros/trip/${params.tripId}`, {
            headers: {
    ...
    const decideCandidate = (approve, candidateId) => {
        ...
        axios.put(`https://us-central1-labenu-apis.cloudfunctions.net/labeX/vitoria-galdino-barros/trips/${params.tripId}/candidates/${candidateId}/decide`, body, {
            headers: {
                auth: window.localStorage.getItem('token')
            }
        }).then(() => {
